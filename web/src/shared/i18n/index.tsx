...
const messages: Record<Locale, TranslationDictionary> = {
  ru: {
    ...
    common: {
      ...
      exportCsvPageShort: 'CSV стр.',
      exportCsvAll: 'Экспорт CSV (все по фильтрам)',
      exportCsvAllShort: 'CSV всё',
    ...
    settings: {
      ...
      telegramReport: 'Отчёт в Telegram',
      telegramReportDescription: 'Раз в день в выбранное время вы получите уведомление: сколько появилось новых (уникальных) вакансий по запросу и ссылки на них (до 5). Если новых нет — короткое сообщение об этом.',
      telegramReportEnable: 'Включить отправку отчётов в Telegram',
      telegramReportInstructions: 'Добавьте бота в группу или напишите ему в личку. Чтобы узнать ID чата: добавьте в группу бота @userinfobot, перешлите ему любое сообщение — он покажет chat_id (например -1001234567890). Введите chat_id ниже.',
      telegramReportChatId: 'ID чата Telegram',
      telegramReportChatIdPlaceholder: '-1001234567890 или 123456789',
      telegramReportTime: 'Время отправки',
      telegramReportTimezone: 'Часовой пояс',
      telegramReportQuery: 'Запрос для парсинга',
      telegramReportQueryPlaceholder: 'python backend',
      telegramReportPages: 'Страниц в отчёте',
      telegramReportSaved: 'Настройки отчёта сохранены.',
      telegramReportSaveFailed: 'Не удалось сохранить настройки.',
    },
    vacancies: {
      title: 'Вакансии',
      ...
      preview: {
        drawerLabel: 'Подробности вакансии',
    ...
    errors: {
      ...
      api: {
        ...
        settingsFetchFailed: 'Не удалось загрузить настройки',
  ...
  en: {
    ...
    common: {
      ...
      exportCsvPageShort: 'CSV page',
      exportCsvAll: 'Export CSV (all by filters)',
      exportCsvAllShort: 'CSV all',
    ...
    settings: {
      ...
      telegramReportDescription: 'Once a day at the chosen time you get a notification: how many new (unique) vacancies appeared for your query and links to them (up to 5). If none — a short message.',
      telegramReportEnable: 'Enable Telegram reports',
      telegramReportInstructions: 'Add the bot to a group or message it. To get chat ID: add @userinfobot to the group, forward any message to it — it will show chat_id (e.g. -1001234567890). Enter chat_id below.',
      telegramReportChatId: 'Telegram chat ID',
      telegramReportChatIdPlaceholder: '-1001234567890 or 123456789',
      telegramReportTime: 'Report time',
      telegramReportTimezone: 'Timezone',
      telegramReportQuery: 'Parse query',
      telegramReportQueryPlaceholder: 'python backend',
      telegramReportPages: 'Pages in report',
      telegramReportSaved: 'Report settings saved.',
      telegramReportSaveFailed: 'Failed to save settings.',
    },
    vacancies: {
      title: 'Vacancies',
    ...
    errors: {
      ...
      api: {
        ...
        settingsFetchFailed: 'Failed to load settings',
